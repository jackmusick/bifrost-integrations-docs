...
1. Imports Python files with the proper decorators
1. Registers metadata
1. Exposes via REST API
...
-   [Installation Guide](/getting-started/installation) - Deploy to Azure
