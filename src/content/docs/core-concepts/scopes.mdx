...
Configs marked `secret` are encrypted at rest but follow the same scope cascade as any other config — see [Storing Sensitive Config Values](/how-to-guides/integrations/secrets-management/) for usage details.
