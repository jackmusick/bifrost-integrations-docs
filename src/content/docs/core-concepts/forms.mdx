...
The Form Builder provides a drag-and-drop interface for creating and editing forms. You can add fields from the palette on the left, configure their properties, and arrange them in the form canvas.
