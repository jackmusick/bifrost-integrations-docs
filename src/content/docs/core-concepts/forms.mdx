...
Forms provide a user-friendly interface for executing workflows. The Forms page lists all available forms that users can access based on their permissions.

![Forms List](../../../assets/core-concepts/forms-list.png)
...
Click **+ New Form** to open the Form Information modal. It collects the form's organization scope, name, linked workflow, description, access level, assigned roles, and an optional launch workflow. Once saved, the builder opens the canvas where you drag fields from the left palette and configure each one.

![Form Builder](../../../assets/core-concepts/form-builder.png)
