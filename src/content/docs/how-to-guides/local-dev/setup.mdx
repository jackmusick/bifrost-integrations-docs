...
This watches your workspace and auto-syncs every file change. Keep it running while you develop. The watch TUI shows structured log columns (time, action, path, user) with color coding.
