...
<LinkCard
  ...
  href="/how-to-guides/tables/editing-policies/"
  description="Author policies through the in-app editor with live server-side validation and a copy-paste reference panel."
/>
