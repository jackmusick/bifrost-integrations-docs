...
First, open the form builder and click the gear icon on a field to edit it. Scroll down to the **Visibility Expression** section:

![Visibility Expression Configuration](../../../../assets/screenshots/visibility-expression.png)
