...
The Coding Agent is a special system agent for creating and modifying Bifrost workflows. It provides AI-assisted development capabilities directly within the platform.
