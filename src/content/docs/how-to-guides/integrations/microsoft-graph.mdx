...
- [OAuth connection configured](/getting-started/oauth-integration) for Microsoft Graph
...
<Aside type="note">
Bifrost automatically refreshes expired tokens. Always get a fresh token at the start of your workflow.
</Aside>
...
- [OAuth Integration](/getting-started/oauth-integration) - Set up Microsoft Graph OAuth
