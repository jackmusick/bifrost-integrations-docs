...
![Settings SSO Landing](../../../../assets/sso/settings-sso-landing.png)
...
5. **Configure in Bifrost**
   ...
   ![Microsoft Entra ID configuration card](../../../../assets/sso/microsoft-card-empty.png)
...
4. **Configure in Bifrost**
   ...
   ![Add Google SSO Dialog](../../../../assets/sso/add-google-dialog.png)
...
3. **Configure in Bifrost**
   ...
   ![Add OIDC SSO Dialog](../../../../assets/sso/add-oidc-dialog.png)
...
![SSO Configured State](../../../../assets/sso/configured-state.png)

![Login Page with SSO Buttons](../../../../assets/sso/login-buttons.png)
