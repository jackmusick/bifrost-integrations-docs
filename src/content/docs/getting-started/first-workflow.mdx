...
1. Click **Execute Workflow**, enter your name, and click **Run**
...
Navigate to **History** in the sidebar to see your past workflow runs. The list is empty until you execute something — runs accumulate here over time with logs and results.
