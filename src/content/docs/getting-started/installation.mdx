...
To enable single sign-on, configure one or more providers:

```bash
# Microsoft Entra ID
BIFROST_MICROSOFT_CLIENT_ID=your-client-id
BIFROST_MICROSOFT_CLIENT_SECRET=your-client-secret
BIFROST_MICROSOFT_TENANT_ID=common

# Google
BIFROST_GOOGLE_CLIENT_ID=your-client-id
BIFROST_GOOGLE_CLIENT_SECRET=your-client-secret

# Generic OIDC
BIFROST_OIDC_DISCOVERY_URL=https://your-idp/.well-known/openid-configuration
BIFROST_OIDC_CLIENT_ID=your-client-id
BIFROST_OIDC_CLIENT_SECRET=your-client-secret
```
