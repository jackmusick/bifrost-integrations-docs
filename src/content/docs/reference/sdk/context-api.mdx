...
Legacy properties (deprecated but still available):
...
Use new properties in new code.
...
- [bifrost Module Reference](/reference/sdk/bifrost-module) - Full SDK reference
- [Decorators Reference](/reference/sdk/decorators) - Decorator parameters
- [Writing Workflows](/guides/workflows/writing-workflows) - Practical guide
